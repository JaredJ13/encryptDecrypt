(function() {
    ...
    2: [
        function(require, module, exports) {
            ...
            // Variables
            const userInput1 = document.querySelector('#textInput');
            ...
            encryptButton.addEventListener('click', function(e) {
                e.preventDefault();
                encryptUserInput(userInput1.value);
            });
    ...
    `;
            ...
            function decryptUserInput(userInput) {
                ...
                if (existingEncryption === undefined) window.alert('Encryption not stored in program array. Please only use encryptions created with this program.');
                else {
            ...
            (function(root, factory) {
                ...
                (function(Math) {
                    ...
                    (function() {
                        ...
                        while(nPrime < 64){
                            if (isPrime(n2)) {
                                if (nPrime < 8) H1[nPrime] = getFractionalBits(Math.pow(n2, 0.5));
                                K[nPrime] = getFractionalBits(Math.pow(n2, 1 / 3));
                                nPrime++;
                            }
                            n2++;
                        }
...
//# sourceMappingURL=index.4ee509ec.js.map
